package dev.prangellplays.infuse.item.ability_crystal.primary;
...
public class FeatherAbilityCrystal extends Item {
    public FeatherAbilityCrystal(Settings settings) {
        super(settings);
    }

    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        user.removeStatusEffect(InfuseEffects.FEATHER);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        {
            tooltip.add(Text.translatable("item.infuse.primary_ability_crystal.description"));
        }
