package dev.prangellplays.infuse.effect.secondary;
...
public class OceanAbilityStatusEffect extends StatusEffect {
    public OceanAbilityStatusEffect(StatusEffectCategory category, int color) {
